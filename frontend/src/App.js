...
import logo from "./images/rd_chat.jpg";
    ...
    <div className="flex justify-center">
      <div className="m-8">
        ...
        <p className="mt-5 text-center text-3xl font-bold tracking-tight text-gray-900 my-10">
          ...
          <span className="block text-indigo-600 xl:inline">Chat project</span>{' '} <br></br>
        </p>
        ...
        <div class="max-w-2xl border rounded">
          <div class="">
            ...
            <div class="relative flex justify-center p-3 border-b border-gray-300">
              ...
              <span class="block ml-2 pt-2 font-bold text-gray-600">React-Django chat</span>
            </div>
